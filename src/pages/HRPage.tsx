        ...
        <div className="min-h-screen bg-[#F8F9FA] text-slate-900">
            <header className="bg-indigo-900 text-white px-6 py-3 flex justify-between items-center sticky top-0 z-50 shadow-md">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-lg font-bold tracking-tight text-white">Ressources Humaines</h1>
                </div>
            </header>
            ...
            <div className="bg-white border-b border-slate-200 px-6 py-4 flex justify-between items-center sticky top-[52px] z-40">
                <div className="flex gap-4">
                    <button
                        ...
                        className="bg-orange-600 text-white px-6 py-2.5 rounded-xl font-black text-sm shadow-lg shadow-orange-100 hover:bg-orange-700 transition-all font-display"
                    >
                        ➕ NOUVEL EMPLOYÉ
                    </button>
                    <button className="bg-white border border-slate-300 text-slate-600 px-6 py-2.5 rounded-xl font-black text-sm uppercase tracking-widest text-[10px]">LISTE DES PAIES</button>
                </div>
            </div>
            ...
            <main className="p-8">
                {loading ? (
                        ...
                        {employees.map((emp) => (
                            <div key={emp.id} className="bg-white p-6 rounded-[2.5rem] border border-slate-200 shadow-sm hover:shadow-xl hover:shadow-orange-50 transition-all group overflow-hidden relative">
                                <div className="flex items-center gap-4 mb-6">
                                    <div className="w-16 h-16 rounded-3xl bg-orange-100 flex items-center justify-center text-2xl font-black text-orange-600 uppercase">
                    ...
                    <div className="bg-white rounded-[2rem] border border-slate-200 shadow-sm p-24 text-center max-w-4xl mx-auto animate-odoo-in">
                        ...
                        <button
                            onClick={() => setShowAddForm(true)}
                            className="bg-orange-600 text-white px-10 py-4 rounded-2xl font-black shadow-lg shadow-orange-100 hover:bg-orange-700 transition-all font-display"
                        >
