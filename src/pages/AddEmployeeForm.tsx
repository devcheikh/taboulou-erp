        ...
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm flex items-center justify-center z-[100] p-4 text-slate-900">
            <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-lg overflow-hidden animate-odoo-in">
                <div className="bg-orange-600 px-8 py-6 text-white flex justify-between items-center">
                    <h2 className="text-xl font-black text-white">Nouvel Employé</h2>
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-6 text-slate-900">
                    ...
                    <div className="pt-4 flex gap-4">
                        ...
                        <button type="submit" disabled={loading} className="flex-2 bg-orange-600 text-white px-8 py-4 rounded-2xl font-black shadow-lg shadow-orange-100 hover:bg-orange-700 disabled:opacity-50 transition-all font-display uppercase tracking-widest text-[10px]">
