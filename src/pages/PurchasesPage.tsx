...
export default function PurchasesPage() {
    ...
    return (
        <div className="min-h-screen bg-[#F8F9FA] text-slate-900 selection:bg-red-100">
            <header className="bg-indigo-900 text-white px-6 py-3 flex justify-between items-center sticky top-0 z-50 shadow-md">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-lg font-bold tracking-tight text-white">Achats & Fournisseurs</h1>
                </div>
            </header>
            ...
            <div className="bg-white border-b border-slate-200 px-6 py-4 flex justify-between items-center sticky top-[52px] z-40">
                <button
                    ...
                    className="bg-red-500 text-white px-8 py-3 rounded-xl font-black text-sm shadow-lg shadow-red-100 hover:bg-red-600 transition-all font-display"
                >
                    ➕ NOUVEL ACHAT
                </button>
            </div>
            ...
            <main className="p-8">
                {loading ? (
                    ...
                    <div className="bg-white rounded-[2rem] border border-slate-200 shadow-sm p-24 text-center max-w-4xl mx-auto animate-odoo-in">
                        ...
                        <button onClick={() => setShowAddForm(true)} className="bg-red-500 text-white px-8 py-3 rounded-2xl font-black shadow-lg shadow-red-100 hover:bg-red-600 transition-all font-display">
                            NOUVEL ACHAT
                        </button>
                    </div>
                )}
