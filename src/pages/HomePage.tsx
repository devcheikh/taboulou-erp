    ...
    return (
        <div className="min-h-screen bg-[#F0F2F5] selection:bg-indigo-100">
            ...
            <main className="relative z-10 max-w-6xl mx-auto px-6 py-16 md:py-24">
                {/* HEADER */}
                <div className="text-center mb-16 animate-odoo-in">
                ...
                <div className="mt-20 p-8 rounded-[3rem] bg-indigo-900 text-white shadow-2xl relative overflow-hidden animate-odoo-in" style={{ animationDelay: '500ms' }}>
