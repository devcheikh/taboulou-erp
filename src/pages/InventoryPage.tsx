        ...
        <div className="min-h-screen bg-[#F8F9FA] text-slate-900 selection:bg-indigo-100">
            ...
            <header className="bg-indigo-900 text-white px-6 py-3 flex justify-between items-center sticky top-0 z-50 shadow-md">
                <div className="flex items-center gap-4">
                    <Link to="/" className="text-2xl hover:bg-white/10 p-2 rounded-lg transition-colors">
                        🏠
                    </Link>
                    <div className="h-6 w-[1px] bg-indigo-700/50" />
                    <h1 className="text-lg font-bold tracking-tight text-white">Inventaire</h1>
                </div>
            ...
            <main className="p-8">
                {loading ? (
                    ...
                    <div className="bg-white rounded-[2rem] border border-slate-200 shadow-sm overflow-hidden animate-odoo-in">
