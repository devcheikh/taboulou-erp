        ...
        <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm flex items-center justify-center z-[100] p-4 text-slate-900">
            <div className="bg-white rounded-[2.5rem] shadow-2xl w-full max-w-4xl overflow-hidden animate-in fade-in zoom-in-95 duration-300">
                <div className="bg-red-900 px-8 py-6 text-white flex justify-between items-center">
                    <h2 className="text-xl font-black">Nouvel Achat (Entrée Stock)</h2>
                ...
                <div className="p-8 space-y-8 max-h-[80vh] overflow-y-auto">
                    ...
                    <div className="space-y-4">
                        ...
                        <button onClick={addLine} className="w-full border-2 border-dashed border-slate-200 text-slate-400 py-3 rounded-2xl font-bold text-sm hover:border-red-300 hover:text-red-400 transition-all">+ Ajouter une ligne</button>
                    </div>
