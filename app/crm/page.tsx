        ...
        <div className="min-h-screen bg-[#F8F9FA] text-slate-900 selection:bg-purple-100">
            <header className="bg-indigo-900 text-white px-6 py-3 flex justify-between items-center sticky top-0 z-50 shadow-md">
                <div className="flex items-center gap-4">
                    ...
                    <h1 className="text-lg font-bold tracking-tight">CRM & Partenaires</h1>
                </div>
            </header>
            ...
            <div className="bg-white border-b border-slate-200 px-6 py-4 flex justify-between items-center sticky top-[52px] z-40">
                <button
                    ...
                    className="bg-purple-600 text-white px-6 py-2.5 rounded-xl font-black text-sm shadow-lg shadow-purple-100 hover:bg-purple-700 transition-all"
                >
                    ➕ NOUVEAU PARTENAIRE
                </button>
            </div>
            ...
            <main className="p-8">
                {loading ? (
                    ...
                    <div className="bg-white rounded-[2rem] border border-slate-200 shadow-sm p-24 text-center max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
                        ...
                        <button
                            onClick={() => setShowAddForm(true)}
                            className="bg-purple-600 text-white px-8 py-3 rounded-2xl font-black shadow-lg shadow-purple-100 hover:bg-purple-700 transition-all"
                        >
